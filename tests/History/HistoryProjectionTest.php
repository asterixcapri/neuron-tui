...
final class HistoryProjectionTest extends TestCase
{
    public function testAConversationBecomesOneOrderedStreamOfEntries(): void
    {
        ...
        self::assertSame(
            [
                [HistoryEntryKind::UserMessage, 'What is the answer?'],
                [HistoryEntryKind::AssistantMessage, 'Forty-two.'],
                [HistoryEntryKind::UserMessage, 'Why?'],
            ],
    ...
    public function testSystemMessagesNeverProduceAnEntry(): void
    {
        ...
        self::assertSame(
            [[HistoryEntryKind::AssistantMessage, 'Visible.']],
            self::summarize($entries),
        );
    }
    ...
    public function testReasoningContentNeverProducesAnEntry(): void
    {
        ...
        self::assertSame(
            [[HistoryEntryKind::AssistantMessage, 'The review is complete.']],
            self::summarize($entries),
        );
    }
    ...
    public function testAFileNameReachesAnEntryAsASafeBareName(): void
    {
        ...
        self::assertSame(
            [[HistoryEntryKind::UserMessage, '[File: report.pdf]']],
            self::summarize($entries),
        );
    }
    ...
    public function testAnUnnamedFileBecomesTheBarePlaceholder(): void
    {
        ...
        self::assertSame(
            [[HistoryEntryKind::UserMessage, '[File]']],
            self::summarize($entries),
        );
    }
    ...
    public function testAToolCallIsPairedWithItsResult(): void
    {
        ...
        self::assertSame(
            [HistoryEntryKind::UserMessage, HistoryEntryKind::ToolActivity, HistoryEntryKind::AssistantMessage],
            self::kinds($entries),
        );
    ...
    public function testAToolCallWhoseResultNeverArrivesIsStillShown(): void
    {
        ...
        self::assertSame(
            [HistoryEntryKind::ToolActivity, HistoryEntryKind::AssistantMessage],
            self::kinds($entries),
        );
    ...
    public function testTextSentWithAToolCallComesBeforeTheActivity(): void
    {
        ...
        self::assertSame(
            [HistoryEntryKind::AssistantMessage, HistoryEntryKind::ToolActivity],
            self::kinds($entries),
        );
    ...
    public function testTheProjectionCanBeRunAgainAtAnyMoment(): void
    {
        ...
        self::assertSame(
            [[HistoryEntryKind::UserMessage, 'Another Session.']],
     ...
     *
     * @return list<array{HistoryEntryKind, string}>
     */
