...
final class TuiTest extends TestCase
{
    public function testMakeAndConstructorExposeEquivalentTerminalBehaviour(): void
    {
        ...
        self::assertSame(
            ...
            AnsiUtils::stripAnsiCodes($fromMake->getOutput()),
        );
    }
...
MARKDOWN;
    ...
    public function testStoppingImmediatelyAfterRequestingSelectionLeavesWithoutPresentingIt(): void
    {
        ...
        // first. Only externally visible terminal behavior is asserted here.
        \Amp\delay(0.02);
        $terminal->simulateInput("\r");
        ...
        $display = AnsiUtils::stripAnsiCodes($terminal->getOutput());
        self::assertStringNotContainsString('Abandoned selection', $display);
    ...
    public function testSelectedCommandUsesTheLiveAgentAndChangesItsSessionBeforeFailure(): void
    {
        ...
        self::assertStringContainsString('Resulting answer.', $display);
    ...
    public function testClearIsRefusedWhileTheAgentIsWorkingButExitIsNot(): void
    {
        ...
        EventLoop::delay(
            ...
            static function () use (&$refusedDisplay, $terminal): void {
                ...
                // A refused command stays in the composer. Remove its name
                // explicitly: Escape now preserves the draft during a Turn.
